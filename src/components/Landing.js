...
class Landing extends React.Component {
  ...
  <section >
          ...
          <h3 className='mt4 fw1 font-1 pr5-ns pr0' style={{lineHeight: '1.8' }}>Hi I'm Kristin, a Learning Experience Desinger. I help create meaningful, memorable, and motivational learning experiences with a focus on sustainable, accessible, user-centered design.</h3>
          <Social/>
          </div>
