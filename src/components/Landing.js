...
<div>
  <section className='overflow-hidden' >
      <div className='mw8 center db pt2'>
          ...
          <h2 className='fw3' style={{lineHeight: '1.6'}}> I'm James a Digital Product Designer working in Berlin. Previously with
          ...
          <a className='link hover-red' target='blank' href='https://quidco.com/'> Quico</a>.</h2>
        ...
        <svg className='DropShadow w-50 dib-ns dn mt5' width="220" height="500" viewBox="0 0 260 610">
