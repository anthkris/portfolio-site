...
class Landing extends React.Component {
  ...
  <section >
          ...
          <h1 style={{lineHeight: '1.4'}}>Hello! I'm a Product Designer based in Berlin, designing digital experiences using user-centred design principles to create meaningful user experiences.</h1>
