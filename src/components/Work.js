...
class Work extends React.Component {
  render() {
    ...
    <section>
        ...
        <WorkTile title='Suggestv' info='Web platform' summary='Suggestv is the inventor of semantic video distribution. Suggestv brings together content sellers and publishes creating a marketplace for online video.' img='images/preview/suggestv-platfom.jpg' link='Suggestv'/>
        ...
        <WorkTile title='YunoJuno' info='Web platform' summary='YunoJuno connects the best freelancers with great companies. Employers work directly with freelancers with YunoJuno managing contact and payment.' img='images/preview/yunojuno.jpg' link='YunoJuno'/>
        <WorkTileOut title='Numilli' info='Progressive Web App' summary='Web app showing the bitcoin ATM locations - under development' img='images/preview/numilli-site.jpg' link='http://numilli.surge.sh/'/>
