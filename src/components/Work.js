...
class Work extends React.Component {
  render() {
    ...
    <section id='Portfolio'>
        ...
        <WorkTile title='QuidCo' info='Mobile app design' summary='Quidco is the number one cashback service. Partnering with retailers to help consumers earn cashback every year.' img='images/preview/quidco.jpg' link='Quidco'/>
