    ...
    return (
      <section className='center mw8 db ph3'>
        ...
        <div className='pt3 db'>
          ...
          <PlayTile title='Go Design Something' type={websiteTool} img='https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723544/portfolio/preview/gds-briefs' summary='Project briefs for instructional designers. Re-made with ReactJS.' link='http://godesignsomething.co/'/>
          ...
          <PlayTile  title='Build Your Portfolio Course' type={courseTool} img='https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723544/portfolio/preview/gds-course' summary='Create a case-study-based instructional design portfolio.' link='https://kristinanthony.withcoach.com/go-design-something-building-your-job-winning-portfolio'/>
        </div>
      </section>
    )
  }
