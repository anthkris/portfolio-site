    ...
    return (
      <section>
        ...
        <div className='w-70-ns w-100 mt5'>
          ...
          <cite className="f6 pt5 tracked secondary-text fs-normal">Vaidas Mykolaitis<span className='db pt1 f7'>Web Developer @ Suggestv</span></cite>
        </div>
      </section>
    )
  }
