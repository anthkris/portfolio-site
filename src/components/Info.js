...
class Info extends React.Component {
  render() {
    return (
<section>
<div className="mb5 db">
<h1 className='fw3 mt5'>Recommendation</h1>
</div>
<div className='w-60-ns w-100 v-top'>
<p className="f5 f4-m fw3 lh-copy db">James is superlative. He is the kind of product you obtain when you mix hard work, talent, humility, dedication and continuous self-improvement. I'm sure James will shine and do well in anything he tries to do, but when it comes to design he has attributes difficult to find all together: Apart from his design background, James experience goes beyond design having experience with web and mobile development, which gives him and holistic understanding on the matter.</p>
<cite className="f6 pt5 tracked secondary-text fs-normal">Pablo Costa <span className='db pt1 f7'>Android Dev at CrowdScores</span></cite>
</div>
...
<cite className="f6 pt5 tracked secondary-text fs-normal">Vaidas Mykolaitis<span className='db pt1 f7'>Web Developer at Suggestv</span></cite>
</div>
</section>
    )
  }
