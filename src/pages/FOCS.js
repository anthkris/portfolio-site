...
import Canvas1 from "../components/images/FOCS/FOCSCanvas.png";
import Canvas2 from "../components/images/FOCS/FOCSCanvasSecond.png";
    ...
    />
      <div className='ph3 center mw8'>
        <section className='mt3 dib'>
          ...
          <div className='w-100'>
            <img className='mt3' src={Canvas1} alt='Games and Mobile Module in Canvas'/>
          </div>
        </section>
