...
const DeathInvestigation = () =>
    <div className='pt5 case-study'>
      ...
      projectRole='I took on the roles of instructional designer, graphic designer, and elearning developer for this project.'
      ...
      />
        <div className='ph3 center mw8'>
          <section className='mt3 dib'>
            ...
            <img
              className='mt3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723812/portfolio/DeathInvestigation/module_title.min"
              alt="Death Investigation Module Title Page" />
            </div>
            <div className='w-100 w-50-ns fr'>
              <img
                className='mt3'
                src="https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723812/portfolio/DeathInvestigation/blood_test.min"
          ...
          <section className='mt4 dib' id='ux-design'>
            ...
            <img
              className='mt3 mb3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723812/portfolio/DeathInvestigation/field_notesslider"
              alt="Field notes collected over the course of the case" />
            </div>
            <div className='w-100 w-50-ns fr'>
              <img
                className='mt3 mb3'
                src="https://res.cloudinary.com/dhdaswa6t/image/upload/f_auto,dpr_auto,q_60/v1530723812/portfolio/DeathInvestigation/evidence_contaminationslider"
