      ...
      <div className='ph3 center mw8'>
        <section className='mt3 dib'>
          ...
          <div className='w-20-l w-40-ns w-100 img-center fr'>
            <img
              className='mt3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/dpr_auto,q_60/v1530723812/portfolio/UXLX/UXLXPhoneVideo.webp"
              alt="UX video card in a lesson" />
          </div>
          <div className='w-40-l w-60-ns w-100 fr'>
            <img
              className='mt3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/dpr_auto,q_60/v1530723812/portfolio/UXLX/UXLXTabletLessonStart.webp"
        ...
        <section className='mt4 dib' id='ux-design'>
          ...
          <div className='w-20-l w-60-ns w-100 img-center fl'>
            <img
              className='mt3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/dpr_auto,q_60/v1530723812/portfolio/UXLX/UXLXPhoneQuestion.webp"
              alt="Card reflection question" />
          </div>
          <div className='w-40-l w-40-ns w-100 fl'>
            <img
              className='mt3'
              src="https://res.cloudinary.com/dhdaswa6t/image/upload/dpr_auto,q_60/v1530723812/portfolio/UXLX/UXLXTabletVideo.webp"
              alt="UX video" />
          </div>
